...
public class ListaPokemonAdapter extends RecyclerView.Adapter<ListaPokemonAdapter.ViewHolder> {
    ...
    public void agregarListaPokemon(ArrayList<Pokemon> listaPokemon) {
        dataset.addAll(listaPokemon);
        notifyDataSetChanged();
    }

    public class ViewHolder extends RecyclerView.ViewHolder {
        private ImageView fotoImageViewLista;
        private TextView nombreTextViewLista;
        public ViewHolder(View itemView){
            super(itemView);

            fotoImageViewLista = (ImageView) itemView.findViewById(R.id.fotoImageViewLista);
            nombreTextViewLista = (TextView) itemView.findViewById(R.id.nombreTextViewLista);
        }
    }
}
